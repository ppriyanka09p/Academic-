...
public class MyRoomDetailActivity extends AppCompatActivity implements RoomImageOneFragment.GetImageUrlListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<PreferenceAmenity> preferencesAmenities = new ArrayList<PreferenceAmenity>();
            ...
            if (preferences.get(ctr).equals(true)) {
                ...
                switch (ctr) {
                    case 0:
                        //small fam
                        //add to the features list
                        preferencesAmenities.add(new PreferenceAmenity(R.mipmap.ic_fam, getString(R.string.add_room_family_amenity)));
                    ...
                    case 1:
                        //female
                        //add to the features list
                        preferencesAmenities.add(new PreferenceAmenity(R.mipmap.ic_female, getString(R.string.add_room_female_preference)));
                        Log.d("View added", Integer.toString(features.size()));
                        break;
                    case 2:
                        //male
                        //add to the features list
                        preferencesAmenities.add(new PreferenceAmenity(R.mipmap.ic_male, getString(R.string.add_room_male_preference)));
                    ...
                    case 3:
                        //sober habits
                        //add to the features list
                        preferencesAmenities.add(new PreferenceAmenity(R.mipmap.ic_sober, getString(R.string.add_room_habits_amenity)));
                    ...
                    case 4:
                        //professional
                        //add to the features list
                        preferencesAmenities.add(new PreferenceAmenity(R.mipmap.ic_pro, getString(R.string.add_room_professional_amenity)));
                        Log.d("View added", Integer.toString(features.size()));
                        break;
                    case 5:
                        //couple
                        //add to the features list
                        preferencesAmenities.add(new PreferenceAmenity(R.mipmap.ic_couple, getString(R.string.add_room_couple_amenity)));
                        Log.d("View added", Integer.toString(features.size()));
                        break;
                }
            }
