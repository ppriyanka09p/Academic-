...
public class ContactUsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(this).load(R.drawable.room_photo).centerCrop().transition(new DrawableTransitionOptions().crossFade()).into(mContactUsImage);
        ...
        mLayoutWebsite.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent visitWebsite = new Intent(Intent.ACTION_VIEW, Uri.parse("https://roomhunter.com"));
