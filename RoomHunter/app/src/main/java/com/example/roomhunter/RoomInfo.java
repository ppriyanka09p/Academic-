...
public class RoomInfo extends Fragment {
    ...
    protected RadioButton mFullhouseButton, mSharingYesButton, mSharingNoButton;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final View rootView = inflater.inflate(R.layout.room_info_fragment, container, false);
